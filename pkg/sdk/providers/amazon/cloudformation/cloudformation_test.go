		...
		},
		{
			...
			output: outputType{
				...
				expectedObjectPointer: &struct {
					...
					Float:           0.5,
					Int:             -5,
					SemanticVersion: *semver.MustParse("1.2.3-dev.4"),
					String:          "value",
					Uint:            5,
				},
			},
...
func TestParseStackValue(t *testing.T) {
	...
	testCases := []caseType{
		...
		},
		{
			...
			output: outputType{
				expectedError:  errors.New("Invalid Semantic Version"),
		...
		},
		{
			...
			output: outputType{
				expectedError:  nil,
				expectedResult: *semver.MustParse("1.2.3-dev.4"),
			},
		},
		{
		...
		},
		{
			...
			input: inputType{
				...
				objectPointer: &struct {
					...
					Float:           0.0,
					Int:             0,
					SemanticVersion: *semver.MustParse("0.0.0"),
					String:          "",
					Uint:            uint(0),
				},
			},
